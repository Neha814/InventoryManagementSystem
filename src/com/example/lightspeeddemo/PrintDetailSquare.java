...
public class PrintDetailSquare extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.print_detail_square);
		...
		try {
		 ...
		 // STEP 1 : Take an Image of the View
		takeImageOfView();
	}
	...
	pdfDir = new File(Environment.getExternalStorageDirectory()
		...
		mRootView = new View(PrintDetailSquare.this);
		mRootView = localLayoutInflater.inflate(R.layout.print_detail_square, null);
		...
		Log.e("price(square)==",""+Constants.DB_item_price);
		Log.e("description(square)==",""+Constants.DB_description);
		Log.e("barcode format(square)==",""+Constants.BARCODE_FORMAT);
